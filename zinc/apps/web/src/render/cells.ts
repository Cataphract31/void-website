 ...
 * Ore cell sprites.
 *
 * Zinc crystallises hexagonal close-packed, so the shaft is drawn as a lattice
 * of hex plates rather than a crowd of figures — one cell per player. Hexes
 * tile without gaps, stay legible from eight cells to a thousand, and give
 * death something better to do than fade out: the plate fractures.
 *
...
/** Cold rolled zinc, with the one warm accent reserved for the jackpot elsewhere. */
