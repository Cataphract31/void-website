  ...
  return (
    <WhitepaperWrapper>
      ...
      <Section>
        ...
        <Paragraph>
          At the core of VOID is the automated burn bot — a TypeScript service that runs 24/7,
          interacting directly with the Meteora DLMM (Dynamic Liquidity Market Maker) pool on Solana.
        </Paragraph>

        <SubSectionTitle>How It Works</SubSectionTitle>
        <List>
          <ListItem>
            The burn bot checks if the burn timer has elapsed (initially every 12 hours).
          </ListItem>
          <ListItem>
      ...
      <Section>
        ...
        <Paragraph>
          The main VOID/SOL pool is deployed on Meteora DLMM — Solana's most advanced
          concentrated liquidity AMM. DLMM uses discrete price bins that allow precise
          liquidity placement and dynamic fee adjustment based on market volatility.
        </Paragraph>
        <Paragraph>
          At launch, <strong>100% of the VOID supply</strong> is deposited single-sided into
          the pool using a Bid-Ask distribution curve. No initial SOL is required — the first
          buyer provides the SOL at the floor price, and the price moves up from there. This
          creates a natural anti-snipe mechanism.
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          SPL Token-2022 standard on Solana. At creation:
        </Paragraph>
        <List>
          <ListItem>
          ...
          <ListItem>
            <strong>100% into LP</strong> — entire supply deposited into Meteora DLMM at launch, single-sided
          </ListItem>
        </List>
      </Section>

      <Section>
        <SectionTitle>WHY METEORA DLMM?</SectionTitle>
        <Paragraph>
          Meteora's Dynamic Liquidity Market Maker was chosen over alternatives (Raydium, Orca)
          for several key reasons:
        </Paragraph>
        <List>
          <ListItem>
            <strong>Dynamic fees</strong> — base fee + volatility-adjusted variable fee captures more value during high activity
          </ListItem>
          <ListItem>
            <strong>Lower protocol take</strong> — 5% protocol fee vs Raydium's higher share
          </ListItem>
          <ListItem>
            <strong>Bid-Ask strategy</strong> — native support for single-sided liquidity deposits, perfect for launch-day anti-snipe mechanics
          </ListItem>
          <ListItem>
            <strong>Precise liquidity placement</strong> — discrete bins allow surgical control over price ranges and liquidity distribution
          </ListItem>
          <ListItem>
